...
<div class="row">
	<div class="small-12 columns">
		<div class="text-center">
			...
			<p class="large">Wie versprochen gibt es jetzt noch die Möglichkeit für dich, einen Amazon-Gutschein abzustauben:</p>
		</div>
		...
		<div class="row">
			<div class="small-12 medium-8 medium-centered columns">
				<div class="question">
					<p class="large">Unter allen Teilnehmenden verlosen wir zwei Amazon-Gutscheine im Wert von jeweils 5€.</p>
